...
const ProtocolRevenueTableRow = (props: {
  project: ProjectType
  ...
  return (
    <div key={project.name}>
      <TableRowContainer onClick={() => setIsOpen((prevIsOpen) => !prevIsOpen)}>
        ...
        <TableRowColumn>
          {getLabelForPrice(project.revenue_protocol_24h)}
        </TableRowColumn>
        <TableRowColumn>
          {getLabelForPrice(project.revenue_protocol_7d)}
        </TableRowColumn>
        <TableRowColumn>
          {getLabelForPrice(project.revenue_protocol_30d)}
        </TableRowColumn>
        <TableRowColumn>
          {getLabelForPrice(project.revenue_protocol_180d)}
        </TableRowColumn>
        <TableRowColumn style={getColor(project.revenue_protocol_24h_change)}>
          {getLabelForPercentage(project.revenue_protocol_24h_change)}
        </TableRowColumn>
        <TableRowColumn style={getColor(project.revenue_protocol_7d_change)}>
          {getLabelForPercentage(project.revenue_protocol_7d_change)}
        </TableRowColumn>
        <TableRowColumn style={getColor(project.revenue_protocol_30d_change)}>
          {getLabelForPercentage(project.revenue_protocol_30d_change)}
        </TableRowColumn>
        <TableRowColumn style={getColor(project.revenue_protocol_180d_change)}>
          {getLabelForPercentage(project.revenue_protocol_180d_change)}
        </TableRowColumn>
...
export default ProtocolRevenueTableRow
